...
function SplitPaneModal(_ref) {
  ...
  }, icon, /*#__PURE__*/React__default['default'].createElement("h2", {
    className: "text-5xl my-3 font-bold"
  }, header), /*#__PURE__*/React__default['default'].createElement("p", {
    className: "font-bold text-sm"
  }, body))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "p-5 flex flex-col"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "flex justify-end min-h-6"
  }, /*#__PURE__*/React__default['default'].createElement("span", null, "\xA0"), isClosable && /*#__PURE__*/React__default['default'].createElement("button", {
    className: "unstyled",
    onClick: onClose
  }, /*#__PURE__*/React__default['default'].createElement(UilTimes, {
...
function SplitPaneModalContent(_ref2) {
  ...
  }, body)), /*#__PURE__*/React__default['default'].createElement("div", null, children)));
}
...
function MiniModal(_ref) {
  ...
  return isOpen && /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: "flex justify-end min-h-6"
  }, isClosable ? /*#__PURE__*/React__default['default'].createElement("button", {
    className: "unstyled",
    onClick: onClose
  }, /*#__PURE__*/React__default['default'].createElement(UilTimes, {
    className: "text-default"
  })) : /*#__PURE__*/React__default['default'].createElement("span", null, "\xA0")), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "h-full"
  }, children)));
}
...
function SideBar(_ref) {
  ...
  var profileChild = [];
  var arrayChildren = [];
  React__default['default'].Children.forEach(React__default['default'].Children.toArray(children), function (child) {
    if (child.props.footer) {
      ...
      if (child.type === React__default['default'].Fragment) {
        React__default['default'].Children.forEach(child.props.children, function (childFragment) {
          mainBody = /*#__PURE__*/React__default['default'].cloneElement(childFragment, {
        ...
        mainBody = /*#__PURE__*/React__default['default'].cloneElement(child, {
          isExpanded: isExpanded,
          selectedLink: selectedLink,
          isMobile: isMobile
        });
  ...
  var renderButtons = function renderButtons() {
    if (isExpanded) {
      ...
      }, /*#__PURE__*/React__default['default'].createElement(UilAngleLeftB, {
        size: 20
      }));
      ...
      }, /*#__PURE__*/React__default['default'].createElement(UilAngleRightB, {
        size: 20
      }));
    }
  };
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "top-nav"
  }, /*#__PURE__*/React__default['default'].createElement(UilBars, {
    size: 25,
    onClick: function onClick() {
      return sidebarToggle(isExpanded ? false : true);
    }
  ...
  }, /*#__PURE__*/React__default['default'].createElement("section", null, arrayChildren), /*#__PURE__*/React__default['default'].createElement("footer", null, /*#__PURE__*/React__default['default'].createElement(SideBarItem, {
    footer: true
  ...
  }, /*#__PURE__*/React__default['default'].createElement(UilCommentAltLines, {
    size: 20
  }), isExpanded && /*#__PURE__*/React__default['default'].createElement("span", {
    className: "sidebar-item-text"
  }, "Feedback"))), /*#__PURE__*/React__default['default'].createElement(SideBarItem, {
    footer: true
  }, /*#__PURE__*/React__default['default'].createElement("a", {
    className: "sidebar-footer-item",
    ...
    target: "_blank",
    rel: "noreferrer"
  }, /*#__PURE__*/React__default['default'].createElement(UilQuestionCircle, {
    size: 20
  }), isExpanded && /*#__PURE__*/React__default['default'].createElement("span", {
    className: "sidebar-item-text"
...
function ButtonSwitch(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("label", {
    ...
    className: "b-switch-option ".concat(checked ? "b-switch-active" : "")
  }, right)), /*#__PURE__*/React__default['default'].createElement("input", {
...
exports.MiniModalActions = MiniModalActions;
exports.MiniModalContent = MiniModalContent;
exports.SideBar = SideBar;
exports.SideBarItem = SideBarItem;
exports.SplitPaneModal = SplitPaneModal;
exports.SplitPaneModalActions = SplitPaneModalActions;
exports.SplitPaneModalContent = SplitPaneModalContent;
